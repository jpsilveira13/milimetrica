    ...
    <div class="row">
        <div class="container">
            <div class="col-md-4 col-lg-4">
                <img width="250" class="center-block img-responsive" src="{{asset('site/images/newsletter-mail.png')}}" alt="NewsLetter" />
            </div>
        ...
        <div class="container">
            <div class="col-lg-12 text-center" id="brand">
                @foreach($providerImages as $providerImage)
                    <img src="{{url('provider/'.$providerImage->extension)}}"/>
                @endforeach
    ...
    <div class="row">
        <div class="container">
            <div class="col-sm-12 col-md-3 col-lg-3" id="columns">
                <h3 class="no-margin-bottom">Rede Social</h3>
                <div class="fb-page" data-href="https://www.facebook.com/www.comercialmilimetrica.com.br" data-width="250" data-height="203" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/www.comercialmilimetrica.com.br"><a href="https://www.facebook.com/www.comercialmilimetrica.com.br">Milimétrica</a></blockquote></div></div>
            </div>
            <div class="col-sm-6 col-md-3 col-lg-3" id="columns">
                ...
                <ul>
                    ...
                    <li><a href="mailto:contato@comercialmilimetrica.com.br">Trabalhe Conosco</a> </li>
                    <li><a href="">Regiões de Entrega</a> </li>
                </ul>
            </div>
            <div class="col-sm-6 col-md-3 col-lg-3" id="columns">
                <h3 class="no-margin-bottom">Sistema</h3>
                <ul>
            ...
            <div class="col-sm-12 col-md-3 col-lg-3" id="columns">
                <a title="Fale Conosco"  href="mailto:contato@comercialmilimetrica.com.br"> <h3 class="no-margin-bottom">Fale Conosco</h3>
                    <ul>
    ...
    <div class="row">
        <div class="container-fluid backgroundFundo">
            <div class="container container1000px">
                <span class="textFooter">Comercial Milimétrica © Todos os direitos reservados </span>
            </div>
        </div>
    </div>
    <div id="toTop"></div>
