...
@section('content')
    ...
    <div class="container">
        ...
        <!-- mission emprise -->
        <div class="col-lg-12 value-style">
            <div class="title-page title-no-padding">
        ...
        <div class="col-lg-12 value-style">
            ...
            <i class="fa fa-reply"></i>
            <span>Estabelecer relações éticas e de longo prazo com nossos fornecedores e parceiros.</span>
        ...
        <div class="col-lg-12 value-style">
            ...
            <div class="col-lg-6 no-padding-left">
                ...
                <i class="fa fa-reply"></i>
                <span> Respeito às pessoas</span><br />
                <i class="fa fa-reply"></i>
                <span> Integridade</span><br />
                <i class="fa fa-reply"></i>
                <span> Lealdade</span><br />
                <i class="fa fa-reply"></i>
                <span> Solidariedade</span><br />
                <i class="fa fa-reply"></i>
                <span> Respeito à Legalidade</span>
            </div>
            <div class="col-lg-6 no-padding-left">
                <i class="fa fa-reply"></i>
                <span> Respeito ao Meio Ambiente</span><br />
                <i class="fa fa-reply"></i>
                <span> Respeito à Saúde e Segurança do Trabalho</span><br />
                <i class="fa fa-reply"></i>
                <span> Respeito aos Direitos dos Empregados</span><br />
                <i class="fa fa-reply"></i>
                <span> Engajamento Milimétrica: encontrar a melhor solução para o cliente</span>
            </div>
        </div>
